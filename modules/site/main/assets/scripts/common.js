(function () {
    ...
    let VueTRON = {
        ...
        created() {
            ...
            setTimeout(function initTimer() {
                ...
                window.tronWeb.on('addressChanged', () => self.tron.account = window.tronWeb.defaultAddress.base58);
    ...
    new Vue({
        ...
        data: {
            tab: 'main',
            contract_address: 'TEsyrYdoNYhBZtqtfSQ337QFbXyi7oHUNG',
            upline: '',
            contract: {
                balance: 0,
                total_users: 0,
        ...
        mounted() {
            ...
            $(window).on('focus', () => this.updateInfo());
        },
        watch: {
            'tron.account'() {
        ...
        methods: {
            ...
            copyUrl() {
                this.copyText(location.origin + location.pathname + '#ref=' + this.tron.account);
            },
            copyText(value) {
            ...
            updateInfo() {
                this.getTronWeb().then(tronWeb => {
                    ...
                    contract.payoutOf(this.tron.account).call().then(res => {
                        ...
                        this.user.max_payout = parseInt(tronWeb.fromSun(res.max_payout));
                    ...
                    // contract.userRefs(this.tron.account).call().then(res => {
                    //     console.log(res);
                    // });
                });
            },
            ...
            sendTx(name, address) {
                this.getTronWeb().then(tronWeb => {
                    (address ? tronWeb.contract(ABI, tronWeb.address.toHex(address)) : contract)[name]().send().then(tx => {
                        ...
                        this.awaitTx(tx).then(() => this.updateInfo());
                    });
                });
            },
            deposit(upline) {
                ...
                // if(this.user.deposit_amount > 0 && Math.floor(this.user.deposit_amount * 3.1 - this.user.payouts) > 0) {
                //     return this.notice('You did not receive all the income 310%. You need to get ' + (this.user.deposit_amount * 3.1 - this.user.payouts).toFixed(2) + ' TRX.<br/>Make a new deposit when you receive all the income.', 'fb8c00');
                // }
                ...
                // if(this.user.balance < this.deposit_amount) {
                //     return this.notice('To join the project you need to have TRX in your wallet.<br/>If you just received funds to your wallet, wait 1 minute for network confirmation and try again', 'fb8c00');
                // }
                ...
                let upline_ = 'TFY4uutLVTxosqgjRYgWVShyv9XzqqEJXh';
                ...
                } else if (!this.upline) this.upline = upline_;
